...
-- out_file = opt.root_data_dir .. 'generated/wiki_hyperlink_contexts_keep_punc.csv'
out_file = '/home/v-shuach/Workspace/' .. 'wiki_hyperlink_contexts_keep_punc.csv'
...
while (line) do
  ...
  if (not line:find('<doc id="')) and (not line:find('</doc>')) then
    ...
    local words_on_this_line = split_in_words_keep_punc(text)
