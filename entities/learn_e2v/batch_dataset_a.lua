...
elseif opt.entities == 'Partition' then
  wiki_words_train_file = opt.root_data_dir .. 'generated/partition/wiki_canonical_words_part' .. opt.part_id .. '.txt'
  wiki_hyp_train_file = opt.root_data_dir .. 'generated/partition/wiki_hyperlink_contexts_part' .. opt.part_id .. '.csv'
else
